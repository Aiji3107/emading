        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              if(isset($_GET['pesan'])){
                if($_GET['pesan']=='empty'){
                  echo '<i class="text-danger">Form tidak boleh kosong!</i>';
                }else if ($_get['pesan'] == 'gagal'){
                echo '<i class="text-danger">Username dan Password tidak ditemukan!</i>';
                }else if ($_get['pesan'] == 'notlogin'){
                echo '<i class="text-danger">Anda harus melakukan login!</i>';
